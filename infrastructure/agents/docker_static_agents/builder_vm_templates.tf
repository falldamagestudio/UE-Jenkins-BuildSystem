...
resource "google_compute_instance_template" "linux_agent_template" {
    ...
    for_each = var.docker_static_agent_templates.linux
    ...
    disk {
        source_image = var.docker_swarm_agent.linux.vm_image_name
...
resource "google_compute_instance_template" "windows_agent_template" {
    ...
    for_each = var.docker_static_agent_templates.windows
    ...
    disk {
        source_image = var.docker_swarm_agent.windows.vm_image_name
